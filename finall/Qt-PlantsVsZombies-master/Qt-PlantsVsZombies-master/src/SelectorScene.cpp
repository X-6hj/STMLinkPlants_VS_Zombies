          ...
          buttonBleep(new QMediaPlayer(this))
{
    ...
    levels.append({"2", tr("Level 1-2")});
    levels.append({"3", tr("Level 1-3")});
    levels.append({"4", tr("Level 1-4 (Pool)")});
    levels.append({"5", tr("Level 1-5")});
    levels.append({"6", tr("Level 2-1 (Night)")});
    levels.append({"7", tr("Level 2-2 (Night)")});
    levels.append({"8", tr("Level 2-3 (Night)")});
